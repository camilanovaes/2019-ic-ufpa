...
dataset.train = dataset[1:30,]
dataset.test = dataset [31:nrow(dataset),]
...
nn.train = neuralnet(formula, data = dataset.train, hidden = c(3,4), threshold = 0.001, linear.output = F)
