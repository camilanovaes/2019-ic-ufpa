...
rules = set(
  ...
  fuzzy_rule(Umid_solo %is% Dry && Temperatura %is% Cold && Umid_Rel %is% Low, Irr_Duration %is% VeryShort),
  fuzzy_rule(Umid_solo %is% Dry && Temperatura %is% Cold && Umid_Rel %is% Medium, Irr_Duration %is% Short),
